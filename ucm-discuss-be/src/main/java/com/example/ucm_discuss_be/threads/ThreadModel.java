...
public class ThreadModel {
    ...
    @Size(min = 3, max = 255, message = "Thread title must be between 3 and 255 characters")
    @Column(name = "title", nullable = false, length = 255)
    private String title;

    @NotBlank(message = "Thread content is required")
    @Size(min = 1, max = 10000, message = "Thread content must be between 1 and 10000 characters")
